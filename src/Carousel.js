...
class Carousel extends React.PureComponent {
    static propTypes = {
        ...
        slides: this.propTypes.arrayOf(PropTypes.shape(CarouselSlide.propTypes)).isRequired,
    };
    ...
    render() {
        ...
        <div {...rest}>
            ...
            <CarouselButton 
                data-action="prev" 
                onClick={this.handlePrevClick}>Prev</CarouselButton>
            <CarouselButton 
                data-action="next" 
                onClick={this.handleNextClick}>Next</CarouselButton>
        </div>
        );
    }
}
